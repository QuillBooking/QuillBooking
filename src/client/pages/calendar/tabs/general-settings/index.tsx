						...
						<Flex vertical gap={8}>
							...
							{bookingForms === 'select' && (
								<Flex vertical gap={6} className="mt-4">
									<div className="text-base font-semibold">
										{__(
											'Please select which Booking Forms to show in the page?',
											'quillbooking'
										)}
									</div>
									<Checkbox.Group className="flex">
										<Checkbox className="custom-check text-base font-semibold">
											{__(
												'Booking Form 01',
												'quillbooking'
											)}
