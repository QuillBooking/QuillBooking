                                ...
                                <Flex gap={20} vertical>
                                    <Flex vertical gap={8}>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => handleAdditionalSettingsChange('max_invitees', Number(e.target.value))}
                                    ...
                                    >
                                        {__('Display Remaining Spots on Booking Page', 'quillbooking')}
                                    </Checkbox>
                                </Flex>
                            </Card>
                        )}
                        ...
                        <div className="grid grid-cols-2 gap-[15px]">
                            <Locations
                                ...
                                connected_integrations={event.connected_integrations || {
                                    apple: { name: 'apple', connected: false },
                                    google: { name: 'google', connected: false },
                                    outlook: { name: 'outlook', connected: false },
                                    twilio: { name: 'twilio', connected: false },
