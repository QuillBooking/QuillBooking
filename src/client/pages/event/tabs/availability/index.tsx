 ...
 */
import type { Availability, AvailabilityRange, TimeSlot, DateOverrides } from '@quillbooking/client';
import ConfigAPI from '@quillbooking/config';
import { useApi, useNotice } from '@quillbooking/hooks';
import { useEventContext } from '../../state/context';
import { RangeSection, AvailabilitySection, OverridesSection } from './sections';
...
const AvailabilityTab: React.FC = () => {
    ...
    const [dateOverrides, setDateOverrides] = useState<DateOverrides | null>(null);
    ...
    const fetchAvailability = () => {
        ...
        callApi({
            ...
            method: 'GET',
            onSuccess(response: { availability: Availability; range: AvailabilityRange; }) {
    ...
    const applyOverride = () => {
        ...
        const times = isUnavailable ? [{ start: '22:00', end: '22:00' }] : overrideTimes;
            ...
            <Flex vertical gap={40}>
                ...
                <RangeSection
                    ...
                    onRangeTypeChange={(type) => {
                        setRange({
                            ...
                            start_date: type === 'date_range' ? dayjs().format('YYYY-MM-DD') : undefined,
                            end_date: type === 'date_range' ? dayjs().add(90, 'days').format('YYYY-MM-DD') : undefined,
                        });
                    }}
                    onDaysChange={(days) => setRange({ ...range, days })}
                    onDateRangeChange={(start_date, end_date) => setRange({ ...range, start_date, end_date })}
                />
                ...
                <Flex gap={20}>
                    ...
                    <AvailabilitySection
                        ...
                        onToggleCustomAvailability={() => setIsCustomAvailability(!isCustomAvailability)}
                    />
                ...
                <OverrideModal
                    ...
                    onAddTimeSlot={() => setOverrideTimes([...overrideTimes, { start: '09:00', end: '17:00' }])}
