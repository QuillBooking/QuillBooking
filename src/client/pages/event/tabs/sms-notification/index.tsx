...
import { CardHeader, EditNotificationIcon, SmsNotificationIcon } from '@quillbooking/components';
...
const SmsNotificationTab = forwardRef<SmsNotificationsTabHandle, SmsNotificationsTabProps>(({ disabled, setDisabled }, ref) => {
