    ...
    return (
        <Card>
            <CardHeader
                ...
                description={__('Configure your email settings for booking related emails', 'quillbooking')}
            ...
            <Flex vertical gap={25} className='mt-4'>
                <Flex vertical gap={4}>
                    <div className="text-[#3F4254] font-semibold text-[16px] flex gap-1 items-center">
                        ...
                        <span className="text-[#818181] text-[12px] font-normal">
                            {__('Default Name that will be used to send email', 'quillbooking')}
                        </span>
                    </div>
                    <Input
                        id="from_name"
                ...
                <Flex vertical gap={4}>
                    <div className="text-[#3F4254] font-semibold text-[16px] flex gap-1 items-center">
                        ...
                        <span className="text-[#818181] text-[12px] font-normal">
                            {__('Provide Valid Email Address that will be used to send emails', 'quillbooking')}
                        </span>
                    </div>
                    <Input
                        id="from_email"
                    ...
                    <div className="text-[#818181]">
                        {__('Email as per your domain/SMTP settings.', 'quillbooking')}
                    </div>
                </Flex>
                ...
                <Flex vertical gap={4}>
                    <div className="text-[#3F4254] font-semibold text-[16px] flex gap-1 items-center">
                        ...
                        <span className="text-[#818181] text-[12px] font-normal">
                            {__('Default Reply to Name (Optional)', 'quillbooking')}
                        </span>
                    </div>
                    <Input
                        id="reply_to_name"
                ...
                <Flex vertical gap={4}>
                    <Checkbox
                        ...
                        onChange={(e) => updateSettings('use_host_from_name', e.target.checked)}
                    >
                    ...
                    <Checkbox
                        ...
                        onChange={(e) => updateSettings('use_host_reply_to_email', e.target.checked)}
                    >
                        {__('Use Host Email For Replay-to Value For Booking Emails to Guests', 'quillbooking')}
                    </Checkbox>
                    <Checkbox
                        className="custom-check text-[#3F4254] font-semibold"
                        checked={settings.include_ics || false}
                        onChange={(e) => updateSettings('include_ics', e.target.checked)}
                    >
                ...
                <Flex vertical gap={4}>
                    <div className="text-[#3F4254] font-semibold text-[16px] flex gap-1 items-center">
                        {__('Email Footer for Booking related emails', 'quillbooking')}
                        <span className="text-[#818181] text-[12px] font-normal">
                    ...
                    <div className="text-[#3F4254]">
                        ...
                        {__('You have received this email because signed up for an event or made a booking on our website.', 'quillbooking')}
                    </div>
                </Flex>
            </Flex>
