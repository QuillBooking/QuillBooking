    ...
    return (
        <Card>
            <CardHeader
                ...
                description={__('Manage your settings related emails, notifications and other general settings', 'quillbooking')}
                ...
                <Flex vertical gap={25} className='mt-4'>
                    ...
                    <Flex vertical gap={4}>
                        ...
                        <Select
                            ...
                            onChange={(value) => updateSettings('start_from', value)}
                            options={dayOptions}
                        />
                    </Flex>
                    ...
                    <Flex vertical gap={4}>
                        <div className="text-[#3F4254] font-semibold text-[16px]">
                            {__('Mark booking as cancelled automatically after', 'quillbooking')}
                        </div>
                        <Select
                            id="auto_cancel_after"
                            className="w-full rounded-lg h-[48px]"
                            value={settings.auto_cancel_after || 60}
                            onChange={(value) => updateSettings('auto_cancel_after', value)}
                            options={getTimeOptions()}
                        />
                        <div className="text-[#818181]">
                            {__('if customer does not complete the payment for paid events.', 'quillbooking')}
                        </div>
                    </Flex>

                    <Flex vertical gap={4}>
                        <div className="text-[#3F4254] font-semibold text-[16px]">
                            {__('Mark booking as completed automatically after', 'quillbooking')}
                        </div>
                        <Select
                            id="auto_complete_after"
                            className="w-full rounded-lg h-[48px]"
                            value={settings.auto_complete_after || 120}
                            onChange={(value) => updateSettings('auto_complete_after', value)}
                            options={getTimeOptions()}
                        />
                        <div className="text-[#818181]">
                    ...
                    <Flex vertical gap={4}>
                        ...
                        <Select
                            ...
                            onChange={(value) => updateSettings('default_country_code', value)}
                    ...
                    <Flex vertical gap={4}>
                        ...
                        <Checkbox
                            ...
                            onChange={(e) => updateSettings('enable_summary_email', e.target.checked)}
                        >
                            {__('Enable Booking Summary Notification.', 'quillbooking')}
                        </Checkbox>
                    </Flex>
                    ...
                    {settings.enable_summary_email && (
                        <Flex vertical gap={4}>
                            ...
                            <Select
                                ...
                                onChange={(value) => updateSettings('summary_email_frequency', value)}
