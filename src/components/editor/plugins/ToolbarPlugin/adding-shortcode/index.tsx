	...
	return (
		<>
			...
			<Button
				...
				className="bg-[#E3DFF1] border rounded-lg border-[#333333] text-[#52525B] cursor-pointer flex items-center hover:bg-color-primary hover:text-white hover:border-none"
			>
			...
			>
				<Flex gap={10} className="items-center border-b pb-4 mb-4">
					...
					<Header
						header={__('Email Notification', 'quillbooking')}
						subHeader={__(
